...
printint(int fd, int xx, int base, int sgn)
{
 ...
 320:	0f b6 92 b0 06 00 00 	movzbl 0x6b0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 3ed:	ff 24 85 58 06 00 00 	jmp    *0x658(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 452:	75 15                	jne    469 <printf+0xfa>
          s = "(null)";
 454:	be 4f 06 00 00       	mov    $0x64f,%esi
...
free(void *ap)
{
 ...
 4e1:	a1 5c 09 00 00       	mov    0x95c,%eax
 ...
 51d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 51f:	a3 5c 09 00 00       	mov    %eax,0x95c
}
 524:	5b                   	pop    %ebx
 525:	5e                   	pop    %esi
 526:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 57c:	e8 54 ff ff ff       	call   4d5 <free>
  return freep;
 581:	a1 5c 09 00 00       	mov    0x95c,%eax
...
malloc(uint nbytes)
{
 ...
 5a5:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5a8:	8b 0d 5c 09 00 00    	mov    0x95c,%ecx
 ...
 5b4:	eb 4a                	jmp    600 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 5b6:	c7 05 5c 09 00 00 60 	movl   $0x960,0x95c
 5bd:	09 00 00 
 5c0:	c7 05 60 09 00 00 60 	movl   $0x960,0x960
 5c7:	09 00 00 
    base.s.size = 0;
 5ca:	c7 05 64 09 00 00 00 	movl   $0x0,0x964
 5d1:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5d4:	b9 60 09 00 00       	mov    $0x960,%ecx
 ...
 5e5:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5e8:	89 0d 5c 09 00 00    	mov    %ecx,0x95c
      return (void*)(p + 1);
 ...
 605:	73 d4                	jae    5db <malloc+0x46>
    if(p == freep)
 607:	39 05 5c 09 00 00    	cmp    %eax,0x95c
