...
main(int argc, char *argv[])
{
   ...
   e:	53                   	push   %ebx
   f:	51                   	push   %ecx
  10:	81 ec 0c 07 00 00    	sub    $0x70c,%esp
  int pid = getpid();
  16:	e8 b8 03 00 00       	call   3d3 <getpid>
  1b:	89 c6                	mov    %eax,%esi
  check(pid > 0, "getpid() returns non-positive number");
  1d:	85 c0                	test   %eax,%eax
  1f:	0f 8e 9f 00 00 00    	jle    c4 <main+0xc4>

  int sret = setslice(pid, 3);
  25:	83 ec 08             	sub    $0x8,%esp
  28:	6a 03                	push   $0x3
  2a:	56                   	push   %esi
  2b:	e8 c3 03 00 00       	call   3f3 <setslice>

  if (sret < 0) {
  30:	83 c4 10             	add    $0x10,%esp
  33:	85 c0                	test   %eax,%eax
  35:	78 7a                	js     b1 <main+0xb1>
    printf(1, "XV6_SCHEDULER\t setslice(pid, 3) returned -1\n");
  } else {
    struct pstat pstat;
    int pret = getpinfo(&pstat);
  37:	83 ec 0c             	sub    $0xc,%esp
  3a:	8d 9d e8 f8 ff ff    	lea    -0x718(%ebp),%ebx
  40:	53                   	push   %ebx
  41:	e8 c5 03 00 00       	call   40b <getpinfo>

    if (pret != 0) {
  46:	83 c4 10             	add    $0x10,%esp
  49:	85 c0                	test   %eax,%eax
  4b:	74 3c                	je     89 <main+0x89>
      printf(1, "XV6_SCHEDULER\t getpinfo(&pstat) returned -1\n");
  4d:	51                   	push   %ecx
  4e:	51                   	push   %ecx
  4f:	68 74 08 00 00       	push   $0x874
  54:	6a 01                	push   $0x1
  ...
  61:	68 dc 08 00 00       	push   $0x8dc
  66:	6a 01                	push   $0x1
  68:	e8 63 04 00 00       	call   4d0 <printf>
  exit();
  6d:	e8 e1 02 00 00       	call   353 <exit>
  72:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        if (pstat.inuse[i] == 1 && pstat.pid[i] == pid) {
  78:	39 b4 83 00 01 00 00 	cmp    %esi,0x100(%ebx,%eax,4)
  7f:	74 10                	je     91 <main+0x91>
      for (int i = 0; i < NPROC; ++i) {
  81:	83 c0 01             	add    $0x1,%eax
  84:	83 f8 40             	cmp    $0x40,%eax
  87:	74 d5                	je     5e <main+0x5e>
        if (pstat.inuse[i] == 1 && pstat.pid[i] == pid) {
  89:	83 3c 83 01          	cmpl   $0x1,(%ebx,%eax,4)
  8d:	75 f2                	jne    81 <main+0x81>
  8f:	eb e7                	jmp    78 <main+0x78>
          if (pstat.timeslice[i] == 3)
  91:	83 bc 85 e8 fa ff ff 	cmpl   $0x3,-0x518(%ebp,%eax,4)
  98:	03 
  99:	74 4c                	je     e7 <main+0xe7>
            printf(1, "XV6_SCHEDULER\t timeslice of myself in the pstat != 3\n");
  9b:	50                   	push   %eax
  9c:	50                   	push   %eax
  9d:	68 a4 08 00 00       	push   $0x8a4
  a2:	6a 01                	push   $0x1
  a4:	e8 27 04 00 00       	call   4d0 <printf>
  a9:	83 c4 10             	add    $0x10,%esp
          exit();
  ac:	e8 a2 02 00 00       	call   353 <exit>
    printf(1, "XV6_SCHEDULER\t setslice(pid, 3) returned -1\n");
  b1:	53                   	push   %ebx
  b2:	53                   	push   %ebx
  b3:	68 44 08 00 00       	push   $0x844
  b8:	6a 01                	push   $0x1
  ba:	e8 11 04 00 00       	call   4d0 <printf>
  bf:	83 c4 10             	add    $0x10,%esp
  c2:	eb 9a                	jmp    5e <main+0x5e>
  check(pid > 0, "getpid() returns non-positive number");
  c4:	83 ec 0c             	sub    $0xc,%esp
  c7:	68 f8 07 00 00       	push   $0x7f8
  cc:	6a 0f                	push   $0xf
  ce:	68 15 09 00 00       	push   $0x915
  d3:	68 20 08 00 00       	push   $0x820
  d8:	6a 01                	push   $0x1
  da:	e8 f1 03 00 00       	call   4d0 <printf>
  df:	83 c4 20             	add    $0x20,%esp
  e2:	e9 3e ff ff ff       	jmp    25 <main+0x25>
            printf(1, "XV6_SCHEDULER\t SUCCESS\n");
  e7:	52                   	push   %edx
  e8:	52                   	push   %edx
  e9:	68 1e 09 00 00       	push   $0x91e
  ee:	6a 01                	push   $0x1
  f0:	e8 db 03 00 00       	call   4d0 <printf>
  f5:	83 c4 10             	add    $0x10,%esp
  f8:	eb b2                	jmp    ac <main+0xac>
  fa:	66 90                	xchg   %ax,%ax
  fc:	66 90                	xchg   %ax,%ax
  fe:	66 90                	xchg   %ax,%ax
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 98 09 00 00 	movzbl 0x998(%edx),%edx
 ...
 4d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 549:	ff 24 85 40 09 00 00 	jmp    *0x940(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 657:	90                   	nop
          s = "(null)";
 658:	ba 36 09 00 00       	mov    $0x936,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 48 0c 00 00       	mov    0xc48,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 48 0c 00 00    	mov    %edx,0xc48
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 48 0c 00 00    	mov    %edx,0xc48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 48 0c 00 00    	mov    0xc48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d 48 0c 00 00    	mov    0xc48,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 48 0c 00 00    	mov    0xc48,%edx
 ...
 7c7:	0c 00 00 
    base.s.size = 0;
 7ca:	bf 4c 0c 00 00       	mov    $0xc4c,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 50 0c 00 00 00 	movl   $0x0,0xc50
 7e2:	00 00 00 
    if(p->s.size >= nunits){
