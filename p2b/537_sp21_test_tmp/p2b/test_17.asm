...
main(int argc, char *argv[])
{
  ...
  int mypid = getpid();
  16:	e8 28 04 00 00       	call   443 <getpid>
  1b:	89 c7                	mov    %eax,%edi

  compticks0 = get_compticks(mypid);
  1d:	e8 ce 00 00 00       	call   f0 <get_compticks>
  22:	89 c3                	mov    %eax,%ebx
  if (compticks0 < 0) {
  24:	85 c0                	test   %eax,%eax
  26:	0f 88 9a 00 00 00    	js     c6 <main+0xc6>
    exit();
  }
  ...
  2f:	6a 05                	push   $0x5
  31:	e8 1d 04 00 00       	call   453 <sleep>
  ...
  42:	83 c0 01             	add    $0x1,%eax
    j += i * j + 1;
  45:	0f af ca             	imul   %edx,%ecx
  48:	8d 54 0a 01          	lea    0x1(%edx,%ecx,1),%edx
  while (i < iters) {
  4c:	3d 00 92 fe 1e       	cmp    $0x1efe9200,%eax
  51:	75 ed                	jne    40 <main+0x40>
  ...
  56:	f7 da                	neg    %edx
  58:	52                   	push   %edx
  59:	e8 95 03 00 00       	call   3f3 <kill>

    compticks1 = get_compticks(mypid);
  5e:	89 f8                	mov    %edi,%eax
  60:	e8 8b 00 00 00       	call   f0 <get_compticks>
    if (compticks0 < 0) {
  65:	83 c4 10             	add    $0x10,%esp
  68:	85 db                	test   %ebx,%ebx
  6a:	78 6d                	js     d9 <main+0xd9>
      printf(1, "XV6_SCHEDULER\t fetched invalid compticks %d from pstat\n", compticks1);
      exit();
    }

    if (compticks1 <= compticks0) {
  6c:	39 d8                	cmp    %ebx,%eax
  6e:	7f 30                	jg     a0 <main+0xa0>
      printf(1, "XV6_SCHEDULER\t iter %d: compticks %d -> %d did not progress\n",
  70:	83 ec 0c             	sub    $0xc,%esp
  73:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  76:	50                   	push   %eax
  77:	53                   	push   %ebx
  78:	56                   	push   %esi
  for (int iter = 0; iter < 4; ++iter) {
  79:	83 c6 01             	add    $0x1,%esi
      printf(1, "XV6_SCHEDULER\t iter %d: compticks %d -> %d did not progress\n",
  7c:	68 08 09 00 00       	push   $0x908
  81:	6a 01                	push   $0x1
  83:	e8 b8 04 00 00       	call   540 <printf>
  88:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for (int iter = 0; iter < 4; ++iter) {
  8b:	83 c4 20             	add    $0x20,%esp
  8e:	83 fe 04             	cmp    $0x4,%esi
  91:	74 2e                	je     c1 <main+0xc1>
    compticks1 = get_compticks(mypid);
  93:	89 c3                	mov    %eax,%ebx
  95:	eb 95                	jmp    2c <main+0x2c>
  ...
  a6:	56                   	push   %esi
  for (int iter = 0; iter < 4; ++iter) {
  a7:	83 c6 01             	add    $0x1,%esi
      printf(1, "XV6_SCHEDULER\t SUCCESS iter %d\n", iter);
  aa:	68 48 09 00 00       	push   $0x948
  af:	6a 01                	push   $0x1
  b1:	e8 8a 04 00 00       	call   540 <printf>
  b6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  b9:	83 c4 10             	add    $0x10,%esp
  for (int iter = 0; iter < 4; ++iter) {
  bc:	83 fe 04             	cmp    $0x4,%esi
  bf:	75 d2                	jne    93 <main+0x93>
    }
  ...
  exit();
  c1:	e8 fd 02 00 00       	call   3c3 <exit>
    printf(1, "XV6_SCHEDULER\t fetched invalid compticks %d from pstat\n", compticks0);
  c6:	51                   	push   %ecx
  c7:	50                   	push   %eax
  ...
  e0:	6a 01                	push   $0x1
  e2:	e8 59 04 00 00       	call   540 <printf>
      exit();
  e7:	e8 d7 02 00 00       	call   3c3 <exit>
  ec:	66 90                	xchg   %ax,%ax
  ee:	66 90                	xchg   %ax,%ax

000000f0 <get_compticks>:
static int get_compticks(int pid) {
  ...
  f9:	68 c0 0c 00 00       	push   $0xcc0
  fe:	e8 78 03 00 00       	call   47b <getpinfo>
  if (pret != 0) {
 103:	83 c4 10             	add    $0x10,%esp
 106:	85 c0                	test   %eax,%eax
 108:	74 0e                	je     118 <get_compticks+0x28>
 10a:	eb 49                	jmp    155 <get_compticks+0x65>
 10c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (int i = 0; i < NPROC; ++i) {
 110:	83 c0 01             	add    $0x1,%eax
 113:	83 f8 40             	cmp    $0x40,%eax
 116:	74 28                	je     140 <get_compticks+0x50>
    if (pstat.inuse[i] == 1 && pstat.pid[i] == pid)
 118:	83 3c 85 c0 0c 00 00 	cmpl   $0x1,0xcc0(,%eax,4)
 11f:	01 
 120:	75 ee                	jne    110 <get_compticks+0x20>
 122:	39 1c 85 c0 0d 00 00 	cmp    %ebx,0xdc0(,%eax,4)
 129:	75 e5                	jne    110 <get_compticks+0x20>
      return pstat.compticks[i];
 12b:	8b 04 85 c0 0f 00 00 	mov    0xfc0(,%eax,4),%eax
}
 ...
 143:	53                   	push   %ebx
 144:	68 90 08 00 00       	push   $0x890
 149:	6a 01                	push   $0x1
 14b:	e8 f0 03 00 00       	call   540 <printf>
  exit();
 150:	e8 6e 02 00 00       	call   3c3 <exit>
    printf(1, "XV6_SCHEDULER\t getpinfo(&pstat) failed\n");
 155:	50                   	push   %eax
 156:	50                   	push   %eax
 157:	68 68 08 00 00       	push   $0x868
 15c:	6a 01                	push   $0x1
 15e:	e8 dd 03 00 00       	call   540 <printf>
    exit();
 163:	e8 5b 02 00 00       	call   3c3 <exit>
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 4c9:	0f b6 92 c8 09 00 00 	movzbl 0x9c8(%edx),%edx
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b9:	ff 24 85 70 09 00 00 	jmp    *0x970(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
