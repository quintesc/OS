...
main(int argc, char *argv[])
{
   ...
   b:	89 e5                	mov    %esp,%ebp
   d:	57                   	push   %edi
   e:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  13:	56                   	push   %esi
  14:	53                   	push   %ebx
  15:	51                   	push   %ecx
  16:	83 ec 08             	sub    $0x8,%esp
  int mypid = getpid();
  19:	e8 d5 03 00 00       	call   3f3 <getpid>
  int pid_c0 = -1;
  ...
  21:	6a 02                	push   $0x2
  23:	50                   	push   %eax
  24:	e8 ea 03 00 00       	call   413 <setslice>
  if (sret != 0) {
  ...
  43:	50                   	push   %eax
  44:	e8 da 03 00 00       	call   423 <fork2>
    if (pid_c < 0) {
  ...
  54:	0f 44 f8             	cmove  %eax,%edi
      pid_c0 = pid_c;

    if (pid_c == 0) {   // child
  57:	85 c0                	test   %eax,%eax
  59:	74 6a                	je     c5 <main+0xc5>
  for (int i = 0; i < 10; ++i) {
  5b:	83 c6 01             	add    $0x1,%esi
  5e:	b8 04 00 00 00       	mov    $0x4,%eax
  63:	83 fe 0a             	cmp    $0xa,%esi
  66:	75 d8                	jne    40 <main+0x40>
  ...
  6f:	0f 84 7e 00 00 00    	je     f3 <main+0xf3>
    printf(1, "XV6_SCHEDULER\t child 0 should finish before all others"
  75:	52                   	push   %edx
  76:	52                   	push   %edx
  77:	68 64 08 00 00       	push   $0x864
  7c:	6a 01                	push   $0x1
  7e:	e8 6d 04 00 00       	call   4f0 <printf>
  83:	83 c4 10             	add    $0x10,%esp
  int i = 0, j = 0;
  86:	bb 09 00 00 00       	mov    $0x9,%ebx
  ...
  exit();
  9a:	e8 d4 02 00 00       	call   373 <exit>
    printf(1, "XV6_SCHEDULER\t setslice(mypid, 2) failed\n");
  9f:	53                   	push   %ebx
  a0:	53                   	push   %ebx
  a1:	68 18 08 00 00       	push   $0x818
  a6:	6a 01                	push   $0x1
  a8:	e8 43 04 00 00       	call   4f0 <printf>
    exit();
  ad:	e8 c1 02 00 00       	call   373 <exit>
      printf(1, "XV6_SCHEDULER\t fork2(4) failed\n");
  b2:	51                   	push   %ecx
  b3:	51                   	push   %ecx
  b4:	68 44 08 00 00       	push   $0x844
  b9:	6a 01                	push   $0x1
  bb:	e8 30 04 00 00       	call   4f0 <printf>
      exit();
  c0:	e8 ae 02 00 00       	call   373 <exit>
      if (i == 0)   // one child sleeps for 80
  c5:	85 f6                	test   %esi,%esi
  c7:	74 3d                	je     106 <main+0x106>
  int i = 0, j = 0;
  ...
  d2:	83 c0 01             	add    $0x1,%eax
    j += i * j + 1;
  d5:	0f af d3             	imul   %ebx,%edx
  d8:	8d 5c 13 01          	lea    0x1(%ebx,%edx,1),%ebx
  while (i < iters) {
  dc:	3d 00 0e 27 07       	cmp    $0x7270e00,%eax
  e1:	75 ed                	jne    d0 <main+0xd0>
      kill(-wc);  // an unelegant way of "using" the workload value to avoid optimized out
  e3:	83 ec 0c             	sub    $0xc,%esp
  e6:	f7 db                	neg    %ebx
  e8:	53                   	push   %ebx
  e9:	e8 b5 02 00 00       	call   3a3 <kill>
      exit();
  ee:	e8 80 02 00 00       	call   373 <exit>
    printf(1, "XV6_SCHEDULER\t SUCCESS\n");
  f3:	50                   	push   %eax
  f4:	50                   	push   %eax
  f5:	68 c2 08 00 00       	push   $0x8c2
  fa:	6a 01                	push   $0x1
  fc:	e8 ef 03 00 00       	call   4f0 <printf>
 101:	83 c4 10             	add    $0x10,%esp
 104:	eb 80                	jmp    86 <main+0x86>
        sleep(80);
 106:	83 ec 0c             	sub    $0xc,%esp
 109:	6a 50                	push   $0x50
 10b:	e8 f3 02 00 00       	call   403 <sleep>
 110:	83 c4 10             	add    $0x10,%esp
 113:	eb b4                	jmp    c9 <main+0xc9>
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 479:	0f b6 92 3c 09 00 00 	movzbl 0x93c(%edx),%edx
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 e4 08 00 00 	jmp    *0x8e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba da 08 00 00       	mov    $0x8da,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 f4 0b 00 00       	mov    0xbf4,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 f4 0b 00 00    	mov    %edx,0xbf4
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 f4 0b 00 00    	mov    %edx,0xbf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d f4 0b 00 00    	mov    0xbf4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d f4 0b 00 00    	mov    0xbf4,%edi
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 f4 0b 00 00    	mov    %edx,0xbf4
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 f4 0b 00 00 f8 	movl   $0xbf8,0xbf4
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf f8 0b 00 00       	mov    $0xbf8,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 f8 0b 00 00 f8 	movl   $0xbf8,0xbf8
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 fc 0b 00 00 00 	movl   $0x0,0xbfc
 802:	00 00 00 
    if(p->s.size >= nunits){
