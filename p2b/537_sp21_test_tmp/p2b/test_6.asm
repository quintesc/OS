...
main(int argc, char *argv[])
{
  ...
  11:	68 ff ff ff 6f       	push   $0x6fffffff
  16:	e8 40 03 00 00       	call   35b <getpinfo>
  ...
  39:	52                   	push   %edx
  3a:	52                   	push   %edx
  3b:	68 48 07 00 00       	push   $0x748
  40:	6a 01                	push   $0x1
  42:	e8 d9 03 00 00       	call   420 <printf>
  47:	83 c4 10             	add    $0x10,%esp
  4a:	eb e8                	jmp    34 <main+0x34>
  4c:	66 90                	xchg   %ax,%ax
  4e:	66 90                	xchg   %ax,%ax
 ...
 429:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 499:	ff 24 85 a8 07 00 00 	jmp    *0x7a8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5a7:	90                   	nop
          s = "(null)";
 5a8:	ba 9f 07 00 00       	mov    $0x79f,%edx
        while(*s != 0){
