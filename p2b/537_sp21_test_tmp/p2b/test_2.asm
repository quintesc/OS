...
main(int argc, char *argv[])
{
  ...
  2a:	83 c2 01             	add    $0x1,%edx
    j += i * j + 1;
  2d:	0f af c8             	imul   %eax,%ecx
  30:	8d 44 08 01          	lea    0x1(%eax,%ecx,1),%eax
  while (i < iters) {
  34:	81 fa 00 08 af 2f    	cmp    $0x2faf0800,%edx
  ...
  3f:	f7 d8                	neg    %eax
  41:	50                   	push   %eax
  42:	e8 dc 02 00 00       	call   323 <kill>
    exit();
  47:	e8 a7 02 00 00       	call   2f3 <exit>
  ...
  4f:	50                   	push   %eax
  50:	e8 46 03 00 00       	call   39b <getslice>
    if (timeslice == 7) {
  55:	83 c4 10             	add    $0x10,%esp
  58:	83 f8 07             	cmp    $0x7,%eax
  5b:	74 2e                	je     8b <main+0x8b>
  ...
  6b:	83 c4 10             	add    $0x10,%esp
    ...
    wait();
  6e:	e8 88 02 00 00       	call   2fb <wait>
  73:	eb 11                	jmp    86 <main+0x86>
    printf(1, "XV6_SCHEDULER\t fork2(7) failed\n");
  75:	51                   	push   %ecx
  76:	51                   	push   %ecx
  ...
  8b:	52                   	push   %edx
  8c:	52                   	push   %edx
  8d:	68 ed 07 00 00       	push   $0x7ed
  92:	6a 01                	push   $0x1
  94:	e8 d7 03 00 00       	call   470 <printf>
  99:	83 c4 10             	add    $0x10,%esp
  9c:	eb d0                	jmp    6e <main+0x6e>
  9e:	66 90                	xchg   %ax,%ax
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 64 08 00 00 	movzbl 0x864(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 0c 08 00 00 	jmp    *0x80c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba 05 08 00 00       	mov    $0x805,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 767:	0b 00 00 
    base.s.size = 0;
 76a:	bf 10 0b 00 00       	mov    $0xb10,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 776:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 782:	00 00 00 
    if(p->s.size >= nunits){
