...
main(int argc, char *argv[])
{
  ...
  14:	e8 fa 03 00 00       	call   413 <getpid>
  19:	83 ec 08             	sub    $0x8,%esp
  1c:	6a 0e                	push   $0xe
  1e:	50                   	push   %eax
  1f:	e8 0f 04 00 00       	call   433 <setslice>
  if (sret != 0) {
  24:	83 c4 10             	add    $0x10,%esp
  27:	85 c0                	test   %eax,%eax
  29:	0f 85 94 00 00 00    	jne    c3 <main+0xc3>
  ...
  34:	6a 02                	push   $0x2
  36:	e8 08 04 00 00       	call   443 <fork2>
    if (pid_c < 0) {
  ...
  42:	0f 88 d9 00 00 00    	js     121 <main+0x121>
      printf(1, "XV6_SCHEDULER\t fork2(%d) failed\n", timeslices[i]);
      exit();
    }

    if (pid_c == 0) {   // child i
  48:	0f 84 ae 00 00 00    	je     fc <main+0xfc>
    int pid_c = fork2(timeslices[i]);
  4e:	83 ec 0c             	sub    $0xc,%esp
  51:	6a 0a                	push   $0xa
  53:	e8 eb 03 00 00       	call   443 <fork2>
    if (pid_c < 0) {
  ...
  5f:	0f 88 d4 00 00 00    	js     139 <main+0x139>
    if (pid_c == 0) {   // child i
  65:	0f 84 91 00 00 00    	je     fc <main+0xfc>
  int i = 0, j = 0;
  6b:	31 c0                	xor    %eax,%eax
  6d:	8d 76 00             	lea    0x0(%esi),%esi
    j += i * j + 1;
  70:	89 da                	mov    %ebx,%edx
  72:	0f af d0             	imul   %eax,%edx
    i++;
  75:	83 c0 01             	add    $0x1,%eax
    j += i * j + 1;
  78:	8d 5c 13 01          	lea    0x1(%ebx,%edx,1),%ebx
  while (i < iters) {
  7c:	3d 18 7a d8 17       	cmp    $0x17d87a18,%eax
  81:	75 ed                	jne    70 <main+0x70>
      pids[i] = pid_c;
    }
  }
  ...
  86:	f7 db                	neg    %ebx
  88:	53                   	push   %ebx
  89:	e8 35 03 00 00       	call   3c3 <kill>

  int waited_pids[2];
  for (int i = 0; i < 2; ++i) {
    waited_pids[i] = wait();
  8e:	e8 08 03 00 00       	call   39b <wait>
    if (waited_pids[i] < 0) {
  ...
  9a:	78 3a                	js     d6 <main+0xd6>
    waited_pids[i] = wait();
  9c:	e8 fa 02 00 00       	call   39b <wait>
    if (waited_pids[i] < 0) {
  a1:	85 c0                	test   %eax,%eax
  a3:	78 31                	js     d6 <main+0xd6>
  ...
  a5:	39 f3                	cmp    %esi,%ebx
  a7:	75 04                	jne    ad <main+0xad>
  a9:	39 f8                	cmp    %edi,%eax
  ab:	74 3c                	je     e9 <main+0xe9>
    printf(1, "XV6_SCHEDULER\t SUCCESS\n");
  } else {
    printf(1, "XV6_SCHEDULER\t child 1 (timeslice 10) should finish much"
  ad:	50                   	push   %eax
  ae:	50                   	push   %eax
  af:	68 b0 08 00 00       	push   $0x8b0
  b4:	6a 01                	push   $0x1
  b6:	e8 55 04 00 00       	call   510 <printf>
  bb:	83 c4 10             	add    $0x10,%esp
              " earlier than child 0 (timeslice 2)\n");
  }

  exit();
  be:	e8 d0 02 00 00       	call   393 <exit>
    printf(1, "XV6_SCHEDULER\t setslice(getpid(), 14) failed\n");
  c3:	56                   	push   %esi
  c4:	56                   	push   %esi
  c5:	68 38 08 00 00       	push   $0x838
  ca:	6a 01                	push   $0x1
  cc:	e8 3f 04 00 00       	call   510 <printf>
    exit();
  d1:	e8 bd 02 00 00       	call   393 <exit>
      printf(1, "XV6_SCHEDULER\t parent wait failed\n");
  d6:	51                   	push   %ecx
  d7:	51                   	push   %ecx
  d8:	68 8c 08 00 00       	push   $0x88c
  dd:	6a 01                	push   $0x1
  df:	e8 2c 04 00 00       	call   510 <printf>
      exit();
  e4:	e8 aa 02 00 00       	call   393 <exit>
    printf(1, "XV6_SCHEDULER\t SUCCESS\n");
  e9:	52                   	push   %edx
  ea:	52                   	push   %edx
  eb:	68 0d 09 00 00       	push   $0x90d
  f0:	6a 01                	push   $0x1
  f2:	e8 19 04 00 00       	call   510 <printf>
  f7:	83 c4 10             	add    $0x10,%esp
  fa:	eb c2                	jmp    be <main+0xbe>
  int i = 0, j = 0;
  fc:	31 c0                	xor    %eax,%eax
    j += i * j + 1;
  fe:	89 da                	mov    %ebx,%edx
 100:	0f af d0             	imul   %eax,%edx
    i++;
 103:	83 c0 01             	add    $0x1,%eax
    j += i * j + 1;
 106:	8d 5c 13 01          	lea    0x1(%ebx,%edx,1),%ebx
  while (i < iters) {
 10a:	3d 00 e9 a4 35       	cmp    $0x35a4e900,%eax
 10f:	75 ed                	jne    fe <main+0xfe>
      kill(-wc);  // an unelegant way of "using" the workload value to avoid optimized out
 111:	83 ec 0c             	sub    $0xc,%esp
 114:	f7 db                	neg    %ebx
 116:	53                   	push   %ebx
 117:	e8 a7 02 00 00       	call   3c3 <kill>
      exit();
 ...
 126:	53                   	push   %ebx
 127:	50                   	push   %eax
 128:	68 68 08 00 00       	push   $0x868
 12d:	6a 01                	push   $0x1
 12f:	e8 dc 03 00 00       	call   510 <printf>
      exit();
 134:	e8 5a 02 00 00       	call   393 <exit>
    int pid_c = fork2(timeslices[i]);
 139:	b8 0a 00 00 00       	mov    $0xa,%eax
 13e:	eb e6                	jmp    126 <main+0x126>
 ...
 46c:	89 d1                	mov    %edx,%ecx
{
 ...
 499:	0f b6 92 84 09 00 00 	movzbl 0x984(%edx),%edx
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 589:	ff 24 85 2c 09 00 00 	jmp    *0x92c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba 25 09 00 00       	mov    $0x925,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 38 0c 00 00       	mov    0xc38,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 38 0c 00 00    	mov    %edx,0xc38
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 38 0c 00 00    	mov    %edx,0xc38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d 38 0c 00 00    	mov    0xc38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d 38 0c 00 00    	mov    0xc38,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 38 0c 00 00    	mov    0xc38,%edx
 ...
 7ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ef:	89 15 38 0c 00 00    	mov    %edx,0xc38
}
 ...
 7ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 38 0c 00 00 3c 	movl   $0xc3c,0xc38
 807:	0c 00 00 
    base.s.size = 0;
 80a:	bf 3c 0c 00 00       	mov    $0xc3c,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 3c 0c 00 00 3c 	movl   $0xc3c,0xc3c
 816:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 40 0c 00 00 00 	movl   $0x0,0xc40
 822:	00 00 00 
    if(p->s.size >= nunits){
