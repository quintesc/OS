...
main(int argc, char *argv[])
{
  ...
  int mypid = getpid();
  14:	e8 2a 04 00 00       	call   443 <getpid>
  19:	89 c3                	mov    %eax,%ebx

  switches0 = get_num_switches(mypid);
  1b:	e8 e0 00 00 00       	call   100 <get_num_switches>
  int i = 0, j = 0;
  ...
  32:	0f af c8             	imul   %eax,%ecx
    i++;
  35:	83 c0 01             	add    $0x1,%eax
    j += i * j + 1;
  38:	8d 54 0a 01          	lea    0x1(%edx,%ecx,1),%edx
  while (i < iters) {
  3c:	3d 29 56 af 2f       	cmp    $0x2faf5629,%eax
  ...
  46:	f7 da                	neg    %edx
  48:	52                   	push   %edx
  49:	e8 a5 03 00 00       	call   3f3 <kill>

  switches1 = get_num_switches(mypid);
  4e:	89 d8                	mov    %ebx,%eax
  50:	e8 ab 00 00 00       	call   100 <get_num_switches>
  ...
  59:	6a 0f                	push   $0xf
  5b:	53                   	push   %ebx
  5c:	e8 02 04 00 00       	call   463 <setslice>
  if (sret != 0) {
  ...
  72:	83 c2 01             	add    $0x1,%edx
    j += i * j + 1;
  75:	0f af c8             	imul   %eax,%ecx
  78:	8d 44 08 01          	lea    0x1(%eax,%ecx,1),%eax
  while (i < iters) {
  7c:	81 fa 2a 56 af 2f    	cmp    $0x2faf562a,%edx
  ...
  87:	f7 d8                	neg    %eax
  89:	50                   	push   %eax
  8a:	e8 64 03 00 00       	call   3f3 <kill>

  switches2 = get_num_switches(mypid);
  8f:	89 d8                	mov    %ebx,%eax
  91:	e8 6a 00 00 00       	call   100 <get_num_switches>
  ...
  99:	39 c7                	cmp    %eax,%edi
  9b:	7d 27                	jge    c4 <main+0xc4>
  9d:	39 fe                	cmp    %edi,%esi
  9f:	7d 23                	jge    c4 <main+0xc4>
  ...
  a3:	29 f8                	sub    %edi,%eax
  a5:	29 f2                	sub    %esi,%edx
  a7:	8d 04 80             	lea    (%eax,%eax,4),%eax
  aa:	39 c2                	cmp    %eax,%edx
  ac:	7f 3c                	jg     ea <main+0xea>
    printf(1, "XV6_SCHEDULER\t switches2 - switches1 should be much smaller than switches1 - switches0\n");
  ae:	52                   	push   %edx
  af:	52                   	push   %edx
  b0:	68 3c 09 00 00       	push   $0x93c
  b5:	6a 01                	push   $0x1
  b7:	e8 84 04 00 00       	call   540 <printf>
  bc:	83 c4 10             	add    $0x10,%esp
  else
    printf(1, "XV6_SCHEDULER\t SUCCESS\n");

  exit();
  bf:	e8 ff 02 00 00       	call   3c3 <exit>
    printf(1, "XV6_SCHEDULER\t should have switches2 > switches1 > switches0\n");
  c4:	51                   	push   %ecx
  c5:	51                   	push   %ecx
  c6:	68 fc 08 00 00       	push   $0x8fc
  cb:	6a 01                	push   $0x1
  cd:	e8 6e 04 00 00       	call   540 <printf>
  d2:	83 c4 10             	add    $0x10,%esp
  d5:	eb e8                	jmp    bf <main+0xbf>
    printf(1, "XV6_SCHEDULER\t setslice(mypid, 15) failed\n");
  d7:	53                   	push   %ebx
  d8:	53                   	push   %ebx
  d9:	68 d0 08 00 00       	push   $0x8d0
  de:	6a 01                	push   $0x1
  e0:	e8 5b 04 00 00       	call   540 <printf>
    exit();
  e5:	e8 d9 02 00 00       	call   3c3 <exit>
    printf(1, "XV6_SCHEDULER\t SUCCESS\n");
  ea:	50                   	push   %eax
  eb:	50                   	push   %eax
  ec:	68 94 09 00 00       	push   $0x994
  f1:	6a 01                	push   $0x1
  f3:	e8 48 04 00 00       	call   540 <printf>
  f8:	83 c4 10             	add    $0x10,%esp
  fb:	eb c2                	jmp    bf <main+0xbf>
  fd:	66 90                	xchg   %ax,%ax
  ff:	90                   	nop

00000100 <get_num_switches>:
static int get_num_switches(int pid) {
 ...
 109:	68 00 0d 00 00       	push   $0xd00
 10e:	e8 68 03 00 00       	call   47b <getpinfo>
  if (pret != 0) {
 113:	83 c4 10             	add    $0x10,%esp
 116:	85 c0                	test   %eax,%eax
 118:	74 0e                	je     128 <get_num_switches+0x28>
 11a:	eb 3e                	jmp    15a <get_num_switches+0x5a>
 11c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (int i = 0; i < NPROC; ++i) {
 120:	83 c0 01             	add    $0x1,%eax
 123:	83 f8 40             	cmp    $0x40,%eax
 126:	74 1f                	je     147 <get_num_switches+0x47>
    if (pstat.inuse[i] == 1 && pstat.pid[i] == pid)
 128:	83 3c 85 00 0d 00 00 	cmpl   $0x1,0xd00(,%eax,4)
 12f:	01 
 130:	75 ee                	jne    120 <get_num_switches+0x20>
 132:	39 1c 85 00 0e 00 00 	cmp    %ebx,0xe00(,%eax,4)
 139:	75 e5                	jne    120 <get_num_switches+0x20>
}
 13b:	8b 04 85 00 13 00 00 	mov    0x1300(,%eax,4),%eax
 ...
 15a:	52                   	push   %edx
 15b:	52                   	push   %edx
 15c:	68 68 08 00 00       	push   $0x868
 161:	6a 01                	push   $0x1
 163:	e8 d8 03 00 00       	call   540 <printf>
    exit();
 168:	e8 56 02 00 00       	call   3c3 <exit>
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 4c9:	0f b6 92 0c 0a 00 00 	movzbl 0xa0c(%edx),%edx
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b9:	ff 24 85 b4 09 00 00 	jmp    *0x9b4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6c7:	90                   	nop
          s = "(null)";
 6c8:	ba ac 09 00 00       	mov    $0x9ac,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 00 14 00 00       	mov    0x1400,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 00 14 00 00    	mov    %edx,0x1400
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 00 14 00 00    	mov    %edx,0x1400
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d 00 14 00 00    	mov    0x1400,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d 00 14 00 00    	mov    0x1400,%edi
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 00 14 00 00    	mov    0x1400,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 00 14 00 00    	mov    %edx,0x1400
}
 ...
 82f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 00 14 00 00 04 	movl   $0x1404,0x1400
 837:	14 00 00 
    base.s.size = 0;
 83a:	bf 04 14 00 00       	mov    $0x1404,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 04 14 00 00 04 	movl   $0x1404,0x1404
 846:	14 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 84b:	c7 05 08 14 00 00 00 	movl   $0x0,0x1408
 852:	00 00 00 
    if(p->s.size >= nunits){
