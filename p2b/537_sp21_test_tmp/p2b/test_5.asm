...
main(int argc, char *argv[])
{
  ...
  13:	6a 08                	push   $0x8
  15:	6a fc                	push   $0xfffffffc
  17:	e8 67 03 00 00       	call   383 <setslice>
  1c:	89 c6                	mov    %eax,%esi
  int sret2 = setslice(getpid(), -9);
  1e:	e8 40 03 00 00       	call   363 <getpid>
  23:	5b                   	pop    %ebx
  24:	5a                   	pop    %edx
  25:	6a f7                	push   $0xfffffff7
  27:	50                   	push   %eax
  28:	e8 56 03 00 00       	call   383 <setslice>
  ...
  5d:	52                   	push   %edx
  5e:	52                   	push   %edx
  5f:	68 a0 07 00 00       	push   $0x7a0
  64:	6a 01                	push   $0x1
  66:	e8 f5 03 00 00       	call   460 <printf>
  6b:	83 c4 10             	add    $0x10,%esp
  6e:	eb d0                	jmp    40 <main+0x40>
    printf(1, "XV6_SCHEDULER\t SUCCESS\n");
  70:	51                   	push   %ecx
  71:	51                   	push   %ecx
 ...
 3bc:	89 d1                	mov    %edx,%ecx
{
 ...
 3e9:	0f b6 92 7c 08 00 00 	movzbl 0x87c(%edx),%edx
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 24 08 00 00 	jmp    *0x824(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba 1d 08 00 00       	mov    $0x81d,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 2c 0b 00 00       	mov    0xb2c,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d 2c 0b 00 00    	mov    0xb2c,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 2c 0b 00 00    	mov    0xb2c,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 2c 0b 00 00    	mov    %edx,0xb2c
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 2c 0b 00 00 30 	movl   $0xb30,0xb2c
 757:	0b 00 00 
    base.s.size = 0;
 75a:	bf 30 0b 00 00       	mov    $0xb30,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 30 0b 00 00 30 	movl   $0xb30,0xb30
 766:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 34 0b 00 00 00 	movl   $0x0,0xb34
 772:	00 00 00 
    if(p->s.size >= nunits){
