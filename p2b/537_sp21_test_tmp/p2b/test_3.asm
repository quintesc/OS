...
main(int argc, char *argv[])
{
  ...
  int fret = fork2(-5);
  13:	6a fb                	push   $0xfffffffb
  15:	e8 69 03 00 00       	call   383 <fork2>
  int gret = getslice(-2);
  1a:	c7 04 24 fe ff ff ff 	movl   $0xfffffffe,(%esp)
  int fret = fork2(-5);
  21:	89 c6                	mov    %eax,%esi
  int gret = getslice(-2);
  23:	e8 53 03 00 00       	call   37b <getslice>
  ...
  2f:	21 d8                	and    %ebx,%eax
  31:	83 f8 ff             	cmp    $0xffffffff,%eax
  34:	74 35                	je     6b <main+0x6b>
    printf(1, "XV6_SCHEDULER\t SUCCESS\n");
  } else {
    if (fret != -1)
  36:	83 fe ff             	cmp    $0xffffffff,%esi
  39:	75 1d                	jne    58 <main+0x58>
      printf(1, "XV6_SCHEDULER\t fork2(-5) should fail and return -1\n");
    if (gret != -1)
  3b:	83 fb ff             	cmp    $0xffffffff,%ebx
  3e:	75 05                	jne    45 <main+0x45>
      printf(1, "XV6_SCHEDULER\t getslice(-2) should fail and return -1\n");
  }
  
  exit();
  40:	e8 8e 02 00 00       	call   2d3 <exit>
      printf(1, "XV6_SCHEDULER\t getslice(-2) should fail and return -1\n");
  45:	50                   	push   %eax
  46:	50                   	push   %eax
  47:	68 c4 07 00 00       	push   $0x7c4
  4c:	6a 01                	push   $0x1
  ...
  58:	52                   	push   %edx
  59:	52                   	push   %edx
  5a:	68 90 07 00 00       	push   $0x790
  5f:	6a 01                	push   $0x1
  61:	e8 ea 03 00 00       	call   450 <printf>
  66:	83 c4 10             	add    $0x10,%esp
  69:	eb d0                	jmp    3b <main+0x3b>
    printf(1, "XV6_SCHEDULER\t SUCCESS\n");
  6b:	51                   	push   %ecx
  6c:	51                   	push   %ecx
  6d:	68 78 07 00 00       	push   $0x778
  72:	6a 01                	push   $0x1
  74:	e8 d7 03 00 00       	call   450 <printf>
  79:	83 c4 10             	add    $0x10,%esp
  7c:	eb c2                	jmp    40 <main+0x40>
  7e:	66 90                	xchg   %ax,%ax
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 04 08 00 00 	jmp    *0x804(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba fb 07 00 00       	mov    $0x7fb,%edx
        while(*s != 0){
 ...
 5f1:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d 0c 0b 00 00    	mov    0xb0c,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 747:	0b 00 00 
    base.s.size = 0;
 74a:	bf 10 0b 00 00       	mov    $0xb10,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 762:	00 00 00 
    if(p->s.size >= nunits){
