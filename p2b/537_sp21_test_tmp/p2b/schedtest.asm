...
int main(int argc, char* argv[]) {
   ...
   f:	53                   	push   %ebx
  10:	51                   	push   %ecx
  11:	81 ec 18 07 00 00    	sub    $0x718,%esp

  if(argc != 6) {
  17:	83 39 06             	cmpl   $0x6,(%ecx)
int main(int argc, char* argv[]) {
  1a:	8b 59 04             	mov    0x4(%ecx),%ebx
  if(argc != 6) {
  1d:	74 05                	je     24 <main+0x24>
    exit();
  1f:	e8 4f 03 00 00       	call   373 <exit>
  }

  char* loop1[] = { "loop", argv[2] };
  24:	c7 85 d8 f8 ff ff 18 	movl   $0x818,-0x728(%ebp)
  2b:	08 00 00 
  ...
  char* loop2[] = { "loop", argv[4] };
  34:	c7 85 e0 f8 ff ff 18 	movl   $0x818,-0x720(%ebp)
  3b:	08 00 00 
  char* loop1[] = { "loop", argv[2] };
  3e:	89 85 dc f8 ff ff    	mov    %eax,-0x724(%ebp)
  char* loop2[] = { "loop", argv[4] };
  44:	8b 43 10             	mov    0x10(%ebx),%eax
  int slice1 = atoi(argv[1]);
  47:	ff 73 04             	push   0x4(%ebx)
  char* loop2[] = { "loop", argv[4] };
  4a:	89 85 e4 f8 ff ff    	mov    %eax,-0x71c(%ebp)
  int slice1 = atoi(argv[1]);
  50:	e8 ab 02 00 00       	call   300 <atoi>
  int slice2 = atoi(argv[3]);
  55:	59                   	pop    %ecx
  56:	ff 73 0c             	push   0xc(%ebx)
  int slice1 = atoi(argv[1]);
  59:	89 c6                	mov    %eax,%esi
  int slice2 = atoi(argv[3]);
  5b:	e8 a0 02 00 00       	call   300 <atoi>
  ...
  if(!(child1 = fork2(slice1))) {  // child process
  65:	e8 b9 03 00 00       	call   423 <fork2>
  6a:	83 c4 10             	add    $0x10,%esp
  6d:	89 c6                	mov    %eax,%esi
  6f:	85 c0                	test   %eax,%eax
  71:	74 38                	je     ab <main+0xab>
    exec(loop1[0], loop1);
  } else {  // parent process
    if(!(child2 = fork2(slice2))) {
  73:	83 ec 0c             	sub    $0xc,%esp
  76:	57                   	push   %edi
  77:	e8 a7 03 00 00       	call   423 <fork2>
  7c:	83 c4 10             	add    $0x10,%esp
  7f:	89 c7                	mov    %eax,%edi
  81:	85 c0                	test   %eax,%eax
  83:	75 42                	jne    c7 <main+0xc7>
      exec(loop2[0], loop2);  // second child process
  85:	50                   	push   %eax
  86:	50                   	push   %eax
  87:	8d 85 e0 f8 ff ff    	lea    -0x720(%ebp),%eax
  8d:	50                   	push   %eax
  8e:	ff b5 e0 f8 ff ff    	push   -0x720(%ebp)
  94:	e8 12 03 00 00       	call   3ab <exec>
...
//      wait();
    ...
    wait();
  9c:	e8 da 02 00 00       	call   37b <wait>
    wait();
  a1:	e8 d5 02 00 00       	call   37b <wait>
  a6:	e9 74 ff ff ff       	jmp    1f <main+0x1f>
    exec(loop1[0], loop1);
  ab:	8d 85 d8 f8 ff ff    	lea    -0x728(%ebp),%eax
  b1:	52                   	push   %edx
  b2:	52                   	push   %edx
  b3:	50                   	push   %eax
  b4:	ff b5 d8 f8 ff ff    	push   -0x728(%ebp)
  ba:	e8 ec 02 00 00       	call   3ab <exec>
  bf:	83 c4 10             	add    $0x10,%esp
  c2:	e9 58 ff ff ff       	jmp    1f <main+0x1f>
      sleep(atoi(argv[5]));
  c7:	83 ec 0c             	sub    $0xc,%esp
  ca:	ff 73 14             	push   0x14(%ebx)
  cd:	e8 2e 02 00 00       	call   300 <atoi>
  d2:	89 04 24             	mov    %eax,(%esp)
  d5:	e8 29 03 00 00       	call   403 <sleep>
      if(getpinfo(addr)) {
  da:	8d 85 e8 f8 ff ff    	lea    -0x718(%ebp),%eax
  e0:	89 04 24             	mov    %eax,(%esp)
  e3:	e8 43 03 00 00       	call   42b <getpinfo>
  e8:	83 c4 10             	add    $0x10,%esp
  eb:	85 c0                	test   %eax,%eax
  ed:	0f 85 2c ff ff ff    	jne    1f <main+0x1f>
      printf(1, "%d %d\n", addr->compticks[child1], addr->compticks[child2]);
  f3:	ff b4 bd e8 fb ff ff 	push   -0x418(%ebp,%edi,4)
  fa:	ff b4 b5 e8 fb ff ff 	push   -0x418(%ebp,%esi,4)
 101:	68 1d 08 00 00       	push   $0x81d
 106:	6a 01                	push   $0x1
 108:	e8 e3 03 00 00       	call   4f0 <printf>
 10d:	83 c4 10             	add    $0x10,%esp
 110:	eb 8a                	jmp    9c <main+0x9c>
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 569:	ff 24 85 2c 08 00 00 	jmp    *0x82c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 677:	90                   	nop
          s = "(null)";
 678:	ba 24 08 00 00       	mov    $0x824,%edx
        while(*s != 0){
